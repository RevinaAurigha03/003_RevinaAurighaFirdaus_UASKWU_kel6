                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <span class="icon-bar bar3"></span>
                            ...
                            <a class="navbar-brand" href="#" style="font-weight: 800;">ALOSIDEJOB</a>
                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            <thead>
                                                <th>Nama Perusahaan/Nama Toko</th>
                                                    ...
                                                    <div class="modal fade" id="detail<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        ...
                                                        <form method="POST" action="php/lamaran_tambah_proses.php">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <b>Nama Perusahaan/Nama Toko</b><br/>
                                                                    <?php
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="copyright pull-right">
                            ...
                            </script>, Hak Cipta Dari <a href="#"> AloSideJob</a>
                        </div>
                    </div>
                </footer>
            </div>
